  ...
  return (
    <div className="home-container">
      ...
      <section className="min-h-screen flex flex-col justify-center text-dull-white">
        <div className="bg-light-blue p-6 rounded-lg shadow-md mr-0 w-3/4 ml-0"> {/* Moved to the extreme left */}
          <h2 className="text-3xl font-bold mb-4 text-left">ORIGIN</h2> {/* Aligned to left */}
          <p className="max-w-3xl mx-auto text-left text-sm"> {/* Changed text size to 13 */}
          ...
          <h3 className="text-2xl font-semibold mt-6 text-left">Historical Perspectives on Cancer's Origin</h3> {/* Aligned to left */}
          <p className="max-w-3xl mx-auto text-left text-sm"> {/* Changed text size to 13 */}
          ...
          <h3 className="text-2xl font-semibold mt-6 text-left">The Warburg Hypothesis</h3> {/* Aligned to left */}
          <p className="max-w-3xl mx-auto text-left text-sm"> {/* Changed text size to 13 */}
          ...
          <h3 className="text-2xl font-semibold mt-6 text-left">Impact of Delayed Detection on Cancer Outcomes</h3> {/* Aligned to left */}
          <p className="max-w-3xl mx-auto text-left text-sm"> {/* Changed text size to 13 */}
          ...
          <h3 className="text-2xl font-semibold mt-6 text-left">Conclusion</h3> {/* Aligned to left */}
          <p className="max-w-3xl mx-auto text-left text-sm"> {/* Changed text size to 13 */}
      ...
      >
        <div className="why-us-box p-6 rounded-lg bg-primary shadow-md"> {/* Removed border and changed bg-gray-100 to bg-primary */}
          <h2 className="text-3xl font-bold text-white mb-4">WHY DO YOU NEED US?</h2> {/* Changed text-black to text-white */}
          <p className="text-white max-w-3xl mx-auto mb-6"> {/* Changed text-black to text-white */}
          ...
          <div className="flex flex-wrap justify-center gap-6">
            <div className="bg-white p-6 rounded-lg shadow-md w-80"> {/* Changed bg-primary-light to bg-white */}
              <h3 className="text-xl font-semibold text-black">Early Detection</h3> {/* Changed text-gray-700 to text-black */}
              <p className="text-black"> {/* Changed text-gray-500 to text-black */}
                Identifying cancer at an early stage increases the chances of successful treatment.
              </p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md w-80"> {/* Changed bg-primary-light to bg-white */}
              <h3 className="text-xl font-semibold text-black">Affordable & Accessible</h3> {/* Changed text-gray-700 to text-black */}
              <p className="text-black"> {/* Changed text-gray-500 to text-black */}
                AI-driven screening reduces costs and makes cancer detection widely available.
              </p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md w-80"> {/* Changed bg-primary-light to bg-white */}
              <h3 className="text-xl font-semibold text-black">Improving Healthcare</h3> {/* Changed text-gray-700 to text-black */}
              <p className="text-black"> {/* Changed text-gray-500 to text-black */}
